...
resolver.define('getIssueSummary', async ({ payload }) => getIssueSummary(payload.issueKey));
resolver.define('getIssueTimeline', async ({ payload }) => getIssueTimeline(payload.issueKey));
...
resolver.define('markIssueForRebuild', async ({ payload }) => markIssueForRebuild(payload.issueKey));
resolver.define('runIssueRebuild', async ({ payload }) => runIssueRebuild(payload.issueKey));
